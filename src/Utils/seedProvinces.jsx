...
// Contoh data awal minimal
const initial = [
    // aceh: { name: 'Aceh', lat: 5.55, lng: 95.32, positive: 0, neutral: 0, negative: 0, updatedAt: Date.now() },
    // bali: { name: 'Bali', lat: -8.4095, lng: 115.1889, positive: 0, neutral: 0, negative: 0, updatedAt: Date.now() },
...
export function seedProvinces() {
    return set(ref(db, 'provinces'), initial);
}