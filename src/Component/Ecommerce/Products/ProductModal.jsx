            ...
            <Col lg="6" className="product-details text-start">
              ...
              <div className="product-qnty">
                ...
                <InputGroup style={{ width: "50%" }}>
                  ...
                  <Btn attrBtn={{ color: "primary", className: "bootstrap-touchspin-up", onClick: plusQty }}>
                    <i className="fa fa-plus"></i>
                  </Btn>
                </InputGroup>
                <br />
                <div className="addcart-btn">
                  <Link to={`${process.env.PUBLIC_URL}/ecommerce/cart`} className="btn btn-primary " onClick={() => AddToCarts(singleProduct, quantity)}>
                    {AddToCart}
                  </Link>
