...
import { CustomDateFormat, Default, DisableDatepicker, DisableDaysOfWeek, InlineVersion, SelectDateWithTime, SelectTimeOnly, TodayButton } from "../../../../Constant";
    ...
    <Fragment>
      <Form className='theme-form'>
        ...
        <Row className='mb-3'>
          ...
          <Col xl='5' sm='9'>
            <DatePicker className='form-control' selected={startDate} onChange={handleChange} showTimeSelect showTimeSelectOnly timeIntervals={15} timeCaption='Time' dateFormat='h:mm aa' />
          </Col>
        </Row>
        <Row className='mb-3'>
        ...
        <Row className='mb-3'>
          ...
          <Col sm='3'>
            <div className='datepicker-here' data-language='en'>
              <DatePicker className='form-control' selected={startDate} onChange={handleChange} disabled placeholderText='This is disabled' />
            </div>
          </Col>
        </Row>
        <Row>
          ...
          <Col sm='3'>
            <div className='datepicker-here' data-language='en'>
              <DatePicker className='form-control' selected={startDate} onChange={handleChange} inline />
            </div>
          </Col>
        </Row>
      </Form>
