...
import { generateTopNationalAPI } from "./contentFlowService";
...
const TodaysTaskProject = () => {
  ...
  const onClickGenerate = async () => {
    const response = await generateTopNationalAPI();
            ...
            <Row>
              ...
              <Col md="6">
                <div className="d-flex align-items-center justify-content-end">
                  ...
                  >
                    Generate Top National News Now
                  </Button>
                </div>
              </Col>
            </Row>
