...
import Ecommerce from "../Modules/Dashboard/Scope/index";
import AiInsight from "../Modules/Dashboard/AiInsight/index";
import ContentFlow from "../Modules/Dashboard/ContentFlow/index";
import CrisisMgt from "../Modules/Dashboard/CrisisMgt/index";
// import Overview from "../Modules/Dashboard/Overview/index";
...
import ListBerita from "../Component/DashBoard/Home/ListBerita";

export const routes = [
  // { path: `${process.env.PUBLIC_URL}/dashboard/default/`, Component: <Default /> },
  { path: `${process.env.PUBLIC_URL}/scope`, Component: <Ecommerce /> },
  // { path: `${process.env.PUBLIC_URL}/dashboard/project/`, Component: <Project /> },
  { path: `${process.env.PUBLIC_URL}/dashboard`, Component: <Home /> },
  {
    path: `${process.env.PUBLIC_URL}/dashboard/list-berita`,
    Component: <ListBerita />,
  },

  { path: `${process.env.PUBLIC_URL}/insight`, Component: <AiInsight /> },
  {
    path: `${process.env.PUBLIC_URL}/content-flow`,
    Component: <ContentFlow />,
  },
  { path: `${process.env.PUBLIC_URL}/kpi-reporting`, Component: <CrisisMgt /> },
