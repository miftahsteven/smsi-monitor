  ...
  return (
    <Fragment>
      ...
      <UL attrUL={{ className: "simple-list flex-row layout-grid unlimited-color-layout" }}>
        <Input type="color" name="Color-Background1" defaultValue={colorBackground1} onChange={(e) => handleUnlimatedColor1Change(e)} />
        <Input type="color" name="Color-Background2" defaultValue={colorBackground2} onChange={(e) => handleUnlimatedColor2Change(e)} />
        <Btn
          attrBtn={{
            color: "primary",
