      ...
      <UL attrUL={{ className: "simple-list" }}>
        <LI>
          <Form className='form-inline search-form'>
            ...
            <Input className={`form-control-plaintext ${toggleSearch ? "open" : ""}`} type='text' placeholder='Search here.....' value={searchValue} onChange={(e) => handleSearchKeyword(e.target.value)} />
